	...
	<div class="content">
		<div class="container-fluid">
			<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
				<p class="_title0">All users <Button size="small" @click='onUserAddModalOpen()'><Icon type="md-add"/> Add</Button></p>
			...
			<div>
				<Modal
			        ...
			        <Row :gutter="10" >
			        	...
			        	<Col>
				        	<Input type="email" v-model="userEditData.email" placeholder="Email">
				                <Icon type="ios-mail-outline" slot="prefix"/>
				            </Input>
				        </Col>
			        	<Col>
