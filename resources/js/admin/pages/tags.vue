   	...
   	<div class="content">
		<div class="container-fluid">
			...
			<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
				<p class="_title0">Tags <Button size="small" :title="this.isWritePermission ? 'Ok' : 'You don\'t have enaugh permission' " :disabled="this.isWritePermission == false" @click="modal.tagModal = true"> <Icon type="md-add"/> Add</Button></p>
							...
							<tr v-for="(tag, i) in allTags" :key='i' v-if="allTags.length">
								...
								<td>
									 <Tooltip  placement="top-start">
							            <Button type="primary" icon='ios-create-outline' v-if="isUpdatePermission" size='small' @click="onEditTag(tag,i)">
											Edit
										</Button>
							        </Tooltip>
...
<script type="text/javascript">
	...
	export default {
		...
		async created(){
			console.log(this.isWritePermission);
			this.showTags()
		}
	}
</script>